    ...
    public class dachiController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            if(happiness == null){
                ...
                HttpContext.Session.SetInt32("energy", (int)fullness);
        ...
        public IActionResult Feed()
        {
            ...
            if(meals == 0){
                HttpContext.Session.SetString("message", "You do not have any meals to feed your Dojoachi! Consider working first");
                } else if (like == 1){
